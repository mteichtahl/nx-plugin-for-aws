...
describe('runtime-config generator', () => {
  ...
  it('should generate runtime config files', async () => {
    ...
    expect(
      tree.read('packages/test-app/src/components/RuntimeConfig/index.tsx')?.toString()
  ...
  it('should modify main.tsx correctly', async () => {
    ...
    const mainTsxContent = tree.read('packages/test-app/src/main.tsx')?.toString();
  ...
  it('should skip generation if RuntimeConfig already exists', async () => {
    ...
    const firstRunContent = tree.read('packages/test-app/src/components/RuntimeConfig/index.tsx')?.toString();
    ...
    expect(tree.read('packages/test-app/src/components/RuntimeConfig/index.tsx')?.toString()).toBe('modified content');
    expect(tree.read('packages/test-app/src/components/RuntimeConfig/index.tsx')?.toString()).not.toBe(firstRunContent);
  });
  ...
  it('should generate shared constructs', async () => {
    ...
    expect(tree.exists('packages/common/constructs/src/runtime-config/index.ts')).toBeTruthy();
    expect(tree.exists('packages/common/constructs/src/runtime-config/runtime-config.ts')).toBeTruthy();

    // Snapshot the shared constructs files
    expect(tree.read('packages/common/constructs/src/runtime-config/index.ts')?.toString()).toMatchSnapshot('common/constructs-index.ts');
    expect(tree.read('packages/common/constructs/src/runtime-config/runtime-config.ts')?.toString()).toMatchSnapshot('runtime-config.ts');
  });
});
