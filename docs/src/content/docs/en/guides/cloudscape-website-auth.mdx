...
The `UserIdentity` construct automatically adds the necessary <Link path="guides/cloudscape-website#runtime-configuration">Runtime Configuration</Link> to ensure that your website can point to the correct Cognito User Pool for authentication.
