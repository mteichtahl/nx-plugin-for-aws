...
Isso gera um novo site React em `packages/demo-website`.
...
Isso configura os provedores necessários para garantir que seu site possa consumir sua API tRPC.
