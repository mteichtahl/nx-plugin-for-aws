...
1. Add the [license generator](/guides/license) to your project which will automatically manage LICENSE files and source code headers in your workspace.
2. [Create your own generator](/get_started/tutorials/create-generator) to simplify the addition on new tRPC apis.
