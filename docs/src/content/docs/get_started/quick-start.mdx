...
:::tip
For a more in-depth tutorial for building a full-stack application, check out the [Dungeon Adventure Tutorial](/nx-plugin-for-aws/get_started/tutorials/dungeon-game/overview).
:::
