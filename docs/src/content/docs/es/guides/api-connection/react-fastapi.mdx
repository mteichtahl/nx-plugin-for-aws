...
3. Autenticación Cognito añadida mediante el <Link path="/guides/cloudscape-website-auth">generador `ts#cloudscape-website-auth`</Link> si conectas una API que use autenticación Cognito o IAM
